...
TWILIO_SID = os.getenv("TWILIO_SID_SECRET")
STOCK_AUTH = os.getenv("STOCK_AUTH_SECRET")
NEWS_AUTH = os.getenv("NEWS_AUTH_SECRET")
TWILIO_AUTH = os.getenv("TWILIO_AUTH_SECRET")
...
difference = float(yesterday_closing_price) - float(day_before_yesterday_data_closing)
up_down = None
if difference > 0:
    up_down = "🔺"
else:
